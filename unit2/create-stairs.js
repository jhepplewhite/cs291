...
function createStairs() {
	...
	for(var step = 0; step < steps; step++ )
	{
		...
		stepMesh.position.z = step*(horizontalStepDepth-stepThickness);			// centered at origin
		scene.add( stepMesh );
		...
		stepMesh.position.y = stepThickness/2 + verticalStepHeight*(step+1) + (step*stepThickness);
