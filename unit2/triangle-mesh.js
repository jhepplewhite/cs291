...
function drawSquare(x1, y1, x2, y2) {
	...
	// Your code goes here
	square.vertices.push(new THREE.Vector3(x1, y1));
	square.vertices.push(new THREE.Vector3(x2, y1));
	square.vertices.push(new THREE.Vector3(x1, y2));
	square.vertices.push(new THREE.Vector3(x2, y2));
